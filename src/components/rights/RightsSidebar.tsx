...
const categories: Category[] = [
  { id: "constitutional", name: "Constitutional Rights", icon: <Gavel className="h-5 w-5 text-legal-primary" /> },
  { id: "consumer", name: "Consumer Rights", icon: <Clipboard className="h-5 w-5 text-legal-primary" /> },
  { id: "employment", name: "Employment Rights", icon: <User className="h-5 w-5 text-legal-primary" /> },
  { id: "housing", name: "Housing Rights", icon: <Shield className="h-5 w-5 text-legal-primary" /> },
  { id: "family", name: "Family Law Rights", icon: <Users className="h-5 w-5 text-legal-primary" /> },
